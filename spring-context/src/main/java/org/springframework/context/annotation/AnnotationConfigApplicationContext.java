 ...
 */
/**
 * 继承关系 AnnotationConfigApplicationContext (C) ->
...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		/*System.out.println("AnnotationConfigApplicationContext()\n\t" +
				"初始化AnnotatedBeanDefinitionReader and ClassPathBeanDefinitionScanner");*/
	...
	/**
	 * Create a new AnnotationConfigApplicationContext, scanning for components[组件，部件，成份]
	 * in the given packages, registering bean definitions for those components,
	 * and automatically[自动的，不假思索的] refreshing the context.
